...
AA_NewInstructionOperand (AAInstructionOperandType type, unsigned int value);
{
    AAInstructionOperand* result = (AAInstructionOperand*) malloc(sizeof(AAInstructionOperand));
    result->type  = type;
    result->value = value;
...
void
AA_DestroyInstructionOperand (AAInstructionOperand* operand)
{
    free(operand);
}

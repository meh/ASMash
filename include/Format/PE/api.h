...
#ifndef __ASMASH_FORMAT_PE_H
#define __ASMASH_FORMAT_PE_H
...
AASymbol* AA_PE_GetSymbolAt (AAAddress addr);

AAAddress AA_PE_GetSectionAddress (const char* name);

AASection* AA_PE_GetSection (const char* name);

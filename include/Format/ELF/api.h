...
#ifndef __ASMASH_FORMAT_ELF_H
#define __ASMASH_FORMAT_ELF_H
...
AASymbol* AA_ELF_GetSymbolAt (AAAddress addr);

AAAddress AA_ELF_GetSectionAddress (const char* name);

AASection* AA_ELF_GetSection (const char* name);
